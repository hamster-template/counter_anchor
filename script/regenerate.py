...
cpshell = ['cp', '-f', keyfile, './target/deploy/counter_anchor-keypair.json']
subprocess.run(cpshell, capture_output=True, text=True)
print("create new keypair file: ", "./target/deploy/counter_anchor-keypair.json")
...
rsfile = "./programs/counter_anchor/src/lib.rs"
